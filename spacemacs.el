...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(doom-themes beacon idea-darkula-theme)
   dotspacemacs-frozen-packages '()
   dotspacemacs-excluded-packages '(persp-mode eyebrowse highlight-parentheses python-mode yasnippet rainbow-delimiters emoji org-projectile)
